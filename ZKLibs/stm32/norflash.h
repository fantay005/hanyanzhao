...
#define NORFLASH_MANAGEM_ADDR                   ((uint32_t)0x00100000)/*网关地址、服务器IP地址、端口号*/
#define NORFLASH_MANAGEM_TIMEOFFSET 		        ((uint32_t)0x00101000)/*网关参数-开灯偏移、关灯偏移*/
#define NORFLASH_MANAGEM_WARNING   		          ((uint32_t)0x00102000)/*网关参数-告警*/
#define NORFLASH_RESET_TIME           		    	((uint32_t)0x00104000)/*重启时间*/
#define NORFLASH_RESET_COUNT                    ((uint32_t)0x00105000)/*重启次数*/
#define NORFLASH_STRATEGY_BASE 				          ((uint32_t)0x00106000)/*策略参数基址*/
